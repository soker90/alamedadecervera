export const PLACES = [
	{
		...
		body: 'Fue mandado construir por Juan de Villanueva sobre un antiguo canal a finales de <strong>1797</strong> y concluye a finales de 1799.\n' +
		...
		web: null,
		body: "Es el parque más grande, ubicado a la entrada de la localidad, es el parque más grande. En su entrada se " +
		...
		body: "Restos de la agrupación de casas de parientes de los Vela."
	}]
